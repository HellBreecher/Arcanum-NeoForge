...
public final class ItemModelDataGen extends ModelProvider {
    ...
    protected Stream<? extends Holder<Block>> getKnownBlocks() {
        return ArcanumBlocks.BLOCKS.getEntries().stream().map(entry -> net.minecraft.core.registries.BuiltInRegistries.BLOCK.wrapAsHolder(entry.get()));
    }

    @Override
    protected Stream<? extends Holder<Item>> getKnownItems() {
        return Stream.of(
                ArcanumItems.ITEMS.getEntries().stream().map(entry -> net.minecraft.core.registries.BuiltInRegistries.ITEM.wrapAsHolder(entry.get())),
                ArcanumFood.FOODS.getEntries().stream().map(entry -> net.minecraft.core.registries.BuiltInRegistries.ITEM.wrapAsHolder(entry.get())),
                ArcanumBlocks.ITEMS.getEntries().stream().map(entry -> net.minecraft.core.registries.BuiltInRegistries.ITEM.wrapAsHolder(entry.get())),
                ArcanumTools.ITEMS.getEntries().stream().map(entry -> net.minecraft.core.registries.BuiltInRegistries.ITEM.wrapAsHolder(entry.get())),
                ArcanumWeapons.ITEMS.getEntries().stream().map(entry -> net.minecraft.core.registries.BuiltInRegistries.ITEM.wrapAsHolder(entry.get())),
                ArcanumArmor.ITEMS.getEntries().stream().map(entry -> net.minecraft.core.registries.BuiltInRegistries.ITEM.wrapAsHolder(entry.get()))
