...
public class ArcanumArmor {
    ...
    public static final DeferredItem<Item> greensapphirehelmet = ITEMS.register(
            "greensapphirehelmet",
            id -> new BaseArmorItem(ArcanumArmorMaterials.GREEN_SAPPHIRE, ArmorType.HELMET, id)
    );
    public static final DeferredItem<Item> greensapphirechestplate = ITEMS.register(
            "greensapphirechestplate",
            id -> new BaseArmorItem(ArcanumArmorMaterials.GREEN_SAPPHIRE, ArmorType.CHESTPLATE, id)
    );
    public static final DeferredItem<Item> greensapphireleggings = ITEMS.register(
            "greensapphireleggings",
            id -> new BaseArmorItem(ArcanumArmorMaterials.GREEN_SAPPHIRE, ArmorType.LEGGINGS, id)
    );
    public static final DeferredItem<Item> greensapphireboots = ITEMS.register(
            "greensapphireboots",
            id -> new BaseArmorItem(ArcanumArmorMaterials.GREEN_SAPPHIRE, ArmorType.BOOTS, id)
    );

    public static final DeferredItem<Item> blooddiamondhelmet = ITEMS.register(
            "blooddiamondhelmet",
            id -> new BaseArmorItem(ArcanumArmorMaterials.BLOOD_DIAMOND, ArmorType.HELMET, id)
    );
    public static final DeferredItem<Item> blooddiamondchestplate = ITEMS.register(
            "blooddiamondchestplate",
            id -> new BaseArmorItem(ArcanumArmorMaterials.BLOOD_DIAMOND, ArmorType.CHESTPLATE, id)
    );
    public static final DeferredItem<Item> blooddiamondleggings = ITEMS.register(
            "blooddiamondleggings",
            id -> new BaseArmorItem(ArcanumArmorMaterials.BLOOD_DIAMOND, ArmorType.LEGGINGS, id)
    );
    public static final DeferredItem<Item> blooddiamondboots = ITEMS.register(
            "blooddiamondboots",
            id -> new BaseArmorItem(ArcanumArmorMaterials.BLOOD_DIAMOND, ArmorType.BOOTS, id)
    );

    public static final DeferredItem<Item> voiddiamondhelmet = ITEMS.register(
            "voiddiamondhelmet",
            id -> new BaseArmorItem(ArcanumArmorMaterials.VOID_DIAMOND, ArmorType.HELMET, id)
    );
    public static final DeferredItem<Item> voiddiamondchestplate = ITEMS.register(
            "voiddiamondchestplate",
            id -> new BaseArmorItem(ArcanumArmorMaterials.VOID_DIAMOND, ArmorType.CHESTPLATE, id)
    );
    public static final DeferredItem<Item> voiddiamondleggings = ITEMS.register(
            "voiddiamondleggings",
            id -> new BaseArmorItem(ArcanumArmorMaterials.VOID_DIAMOND, ArmorType.LEGGINGS, id)
    );
    public static final DeferredItem<Item> voiddiamondboots = ITEMS.register(
            "voiddiamondboots",
            id -> new BaseArmorItem(ArcanumArmorMaterials.VOID_DIAMOND, ArmorType.BOOTS, id)
    );
