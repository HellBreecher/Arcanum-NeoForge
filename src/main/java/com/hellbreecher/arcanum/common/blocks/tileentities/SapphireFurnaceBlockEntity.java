...
public class SapphireFurnaceBlockEntity extends AbstractFurnaceBlockEntity {
    private static final int SPEED_MULTIPLIER = 5;

    public SapphireFurnaceBlockEntity(BlockPos pos, BlockState state) {
        super(ArcanumBlockEntities.SAPPHIRE_FURNACE.get(), pos, state, RecipeType.SMELTING);
    }

    @Override
    protected Component getDefaultName() {
        return Component.translatable("block.arcanum.sapphirefurnace");
    }
    ...
    public static void serverTick(Level level, BlockPos pos, BlockState state, SapphireFurnaceBlockEntity blockEntity) {
