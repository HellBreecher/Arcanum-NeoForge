    ...
    private final ContainerData dataAccess = new ContainerData() {
        ...
        public int get(int index) {
            return switch (index) {
                ...
                case 2 -> lowInt(InfernalGeneratorBlockEntity.this.energy.getAmountAsLong());
                case 3 -> highInt(InfernalGeneratorBlockEntity.this.energy.getAmountAsLong());
                case 4 -> lowInt(InfernalGeneratorBlockEntity.this.energy.getCapacityAsLong());
                case 5 -> highInt(InfernalGeneratorBlockEntity.this.energy.getCapacityAsLong());
                default -> 0;
            };
        }
