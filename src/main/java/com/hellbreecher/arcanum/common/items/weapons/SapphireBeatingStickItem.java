...
public class SapphireBeatingStickItem extends Item {

    public SapphireBeatingStickItem(Identifier id) {
        super(new Properties()
                .sword(ArcanumToolMaterials.SapphireBeatingStick, 1.0F, -2.4F)
    ...
    public void onCraftedBy(ItemStack stack, Player player) {
        ...
        enchant(stack, level, Enchantments.BANE_OF_ARTHROPODS, 3);
        enchant(stack, level, Enchantments.SMITE, 3);
        enchant(stack, level, Enchantments.KNOCKBACK, 3);
        enchant(stack, level, Enchantments.LOOTING, 3);
    }
