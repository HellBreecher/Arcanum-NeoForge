...
public class VoidDiamondBeatingStickItem extends Item {

    public VoidDiamondBeatingStickItem(Identifier id) {
        super(new Properties()
                .sword(ArcanumToolMaterials.VoidDiamondBeatingStick, 1.0F, -2.4F)
    ...
    public void onCraftedBy(ItemStack stack, Player player) {
        ...
        enchant(stack, level, Enchantments.BANE_OF_ARTHROPODS, 7);
        enchant(stack, level, Enchantments.SMITE, 7);
        enchant(stack, level, Enchantments.KNOCKBACK, 7);
        enchant(stack, level, Enchantments.LOOTING, 7);
    }
