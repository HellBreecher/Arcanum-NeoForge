...
public class InfernalShovelItem extends ShovelItem {
    ...
    public InfernalShovelItem(Identifier id) {
        super(ArcanumToolMaterials.InfernalTool, 1.5F, -3.0F, new Item.Properties()
    ...
    public boolean isCorrectToolForDrops(ItemStack stack, BlockState state) {
        ...
        return isCorrectForTool(state, BlockTags.MINEABLE_WITH_SHOVEL);
    }
