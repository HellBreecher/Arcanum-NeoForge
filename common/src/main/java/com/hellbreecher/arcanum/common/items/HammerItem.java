...
public class HammerItem extends Item implements com.hellbreecher.arcanum.common.item.DynamicCraftingRemainder {
    ...
    public ItemStackTemplate arcanumCraftingRemainder(ItemStack stack) {
        return getCraftingRemainder(stack);
    }
}
