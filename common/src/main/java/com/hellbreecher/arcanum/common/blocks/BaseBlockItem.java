...
public class BaseBlockItem extends BlockItem implements com.hellbreecher.arcanum.common.item.ArcanumFuel {
    ...
    public int getBurnTime(ItemStack itemStack, RecipeType<?> recipeType, FuelValues fuelValues) {
        return arcanumBurnTime(itemStack);
    }

    public int arcanumBurnTime(ItemStack itemStack) {
