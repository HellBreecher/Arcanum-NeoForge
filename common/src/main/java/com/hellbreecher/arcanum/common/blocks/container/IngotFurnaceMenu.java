...
public class IngotFurnaceMenu extends AbstractFurnaceMenu {
    public IngotFurnaceMenu(int containerId, Inventory playerInventory) {
        super(ArcanumMenuTypes.VOID_DIAMOND_FURNACE.get(), RecipePropertySet.FURNACE_INPUT, RecipeBookType.FURNACE, containerId, playerInventory);
    }

    public IngotFurnaceMenu(int containerId, Inventory playerInventory, Container container, ContainerData data) {
        super(ArcanumMenuTypes.VOID_DIAMOND_FURNACE.get(), RecipePropertySet.FURNACE_INPUT, RecipeBookType.FURNACE, containerId, playerInventory, container, data);
    }
}
