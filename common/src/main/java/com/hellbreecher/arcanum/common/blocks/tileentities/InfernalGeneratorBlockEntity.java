    ...
    private final ContainerData dataAccess = new ContainerData() {
        ...
        public int get(int index) {
            return switch (index) {
                ...
                case 2 -> lowInt(InfernalGeneratorBlockEntity.this.energy.amount());
                case 3 -> highInt(InfernalGeneratorBlockEntity.this.energy.amount());
                case 4 -> lowInt(InfernalGeneratorBlockEntity.this.energy.capacity());
                case 5 -> highInt(InfernalGeneratorBlockEntity.this.energy.capacity());
                default -> 0;
            };
        }
