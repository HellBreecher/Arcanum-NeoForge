    ...
    private final ContainerData dataAccess = new ContainerData() {
        ...
        public int get(int index) {
            return switch (index) {
                ...
                case 2 -> lowInt(BloodDiamondGeneratorBlockEntity.this.energy.amount());
                case 3 -> highInt(BloodDiamondGeneratorBlockEntity.this.energy.amount());
                case 4 -> lowInt(BloodDiamondGeneratorBlockEntity.this.energy.capacity());
                case 5 -> highInt(BloodDiamondGeneratorBlockEntity.this.energy.capacity());
                default -> 0;
            };
        }
