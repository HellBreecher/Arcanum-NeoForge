...
public class SapphireGeneratorBlockEntity extends BaseContainerBlockEntity implements WorldlyContainer {
    ...
    private final LongEnergyHandler energy = new LongEnergyHandler(CAPACITY, FE_PER_TICK, CAPACITY) {
        @Override
    ...
    private final ContainerData dataAccess = new ContainerData() {
        ...
        public int get(int index) {
            return switch (index) {
                ...
                case 2 -> lowInt(SapphireGeneratorBlockEntity.this.energy.amount());
                case 3 -> highInt(SapphireGeneratorBlockEntity.this.energy.amount());
                case 4 -> lowInt(SapphireGeneratorBlockEntity.this.energy.capacity());
                case 5 -> highInt(SapphireGeneratorBlockEntity.this.energy.capacity());
                default -> 0;
            };
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                case 0 -> SapphireGeneratorBlockEntity.this.burnTime = value;
                case 1 -> SapphireGeneratorBlockEntity.this.burnTimeTotal = value;
            }
        }
    ...
    public SapphireGeneratorBlockEntity(BlockPos pos, BlockState state) {
        super(ArcanumBlockEntities.SAPPHIRE_GENERATOR.get(), pos, state);
    }

    @Override
    protected Component getDefaultName() {
        return Component.translatable("Sapphire Generator");
    }
    ...
    public ArcanumEnergyStorage getEnergyStorage() {
        return this.energy;
    }
    ...
    private int getBurnTime(ItemStack stack, Level level) {
        ...
        return com.hellbreecher.arcanum.common.item.ItemBehaviors.burnTime(stack, level.fuelValues());
    }

    private boolean canGenerateEnergy() {
        return this.energy.capacity() - this.energy.amount() >= FE_PER_TICK;
    }
    ...
    private void generateEnergy() {
        this.energy.insert(FE_PER_TICK);
    }
    ...
    private void consumeFuel(Level level, BlockPos pos) {
        ...
        ItemStackTemplate remainderTemplate = com.hellbreecher.arcanum.common.item.ItemBehaviors.craftingRemainder(stack);
