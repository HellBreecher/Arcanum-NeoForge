    ...
    private final ContainerData dataAccess = new ContainerData() {
        ...
        public int get(int index) {
            return switch (index) {
                ...
                case 2 -> lowInt(VoidDiamondGeneratorBlockEntity.this.energy.amount());
                case 3 -> highInt(VoidDiamondGeneratorBlockEntity.this.energy.amount());
                case 4 -> lowInt(VoidDiamondGeneratorBlockEntity.this.energy.capacity());
                case 5 -> highInt(VoidDiamondGeneratorBlockEntity.this.energy.capacity());
                default -> 0;
            };
        }
