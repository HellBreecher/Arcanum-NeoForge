...
public final class ArcanumArmorMaterials {
    ...
    private static TagKey<Item> itemTag(String path) {
        return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(ArcanumCommon.MOD_ID, path));
    }

    private static ResourceKey<EquipmentAsset> assetKey(String name) {
        return ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(ArcanumCommon.MOD_ID, name));
    }
}
